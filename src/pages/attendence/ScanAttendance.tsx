...
const ScanAttendance = () => {
    ...
    return (
        <div className='w-full h-full '>
            <h1 className="smallsc1:text-4xl text-2xl text-white font-bold ml-6 mt-4">Add Attendence</h1>
            {/* <div className="flex justify-start space-x-6 items-center smallsc1:p-7 p-5 w-full  overflow-hidden"> */}
            <div className='flex justify-start space-x-6 items-center px-7 py-4 w-full overflow-x-auto scrollbar-hidden'>
            ...
            <div className="w-full lg:flex-row flex-col smallsc1:p-11 p-9 flex flex-1 h-full gap-4 ">
                            ...
                            : (
                                <Card className=" w-full flex-1 flex flex-row h-fit justify-center gap-x-12 items-start bg-gray-900 border border-gray-500 text-white overflow-y-auto scrollbar-hidden">
                                    <CardHeader className="flex justify-center flex-col items-center w-[40%]">
                                        ...
                                        <img
                                            src={studentData?.studentId.image}
                                            alt="profile-picture"
                                            className={`smallsc1:h-52 xl:h-40 h-32 smallsc1:w-52 xl:w-40 w-32 rounded-full ${!studentData?.studentId.image ? 'border border-gray-300' : ""} `}
                                        />
